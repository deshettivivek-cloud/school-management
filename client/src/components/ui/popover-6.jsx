...
const Popover6 = () => {
  ...
  return (
    <Popover
      ...
      <PopoverContent
        className="shadow-3xl w-80 rounded-2xl border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-4">
            <div
              className="relative flex size-11 items-center justify-center rounded-xl border border-neutral-100 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900">
              <span
                className={cn('absolute inset-0 rounded-xl border-2 border-dashed', value === 100
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              <span
                className="block truncate text-sm font-bold tracking-tight text-neutral-900 dark:text-neutral-100">
                {getText()}
              </span>
            ...
            {!isCanceled && (
              <span
                className={cn('text-sm font-bold tabular-nums', value === 100
                  ? 'text-emerald-500'
          ...
          <div className="flex flex-col gap-5">
            <Progress
              value={value}
              className={cn('h-1.5 bg-neutral-50 dark:bg-neutral-900', value === 100
